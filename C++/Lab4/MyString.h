...
class MyString {
    ...
    public:
        ...
        char& operator[](int);
        friend const MyString operator+(const MyString&, const MyString&); /* concateneaza 2 stringuri si salveaza rezultatul intr-un obiect nou de tip MyString
         pe care il returneaza*/
